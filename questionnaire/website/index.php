<?php
    ...
    $seo = get_seo($database_connection, "webdevelopmentquestionnaire");
	...
	<body>
        <div class="page_left" style="padding: 20px;">
            <div class="page_block" style="background-color: #eed67a;">
                ...
                <br />
                ✍🏾 <u>Fill out this questionnaire</u> to get started building your dream website. 
                ...
                <form id="contact_form" class="contact_form" method="post" action="submit.php">
                    ...
                    <br />
                    <div class="contact_label">What is the purpose of the website?</div>
                    <textarea class="contact_textarea" name="answer_1"></textarea>
                    <div class="contact_label">What are the websites’s main features?</div>
                    <textarea class="contact_textarea" name="answer_2"></textarea>
                    <div class="contact_label">What pages should the website have (ex. home page, about page, contact page, etc.)?</div>
                    <textarea class="contact_textarea" name="answer_3"></textarea>
                    <div class="contact_label">Who are the target visitors?</div>
                    <textarea class="contact_textarea" name="answer_4"></textarea>
                    <div class="contact_label">Is there a similar website out there that this website should work like and/or look like?</div>
                    <textarea class="contact_textarea" name="answer_5"></textarea>
                    <div class="contact_label">What are some of the competitor websites (if any)?</div>
                    <textarea class="contact_textarea" name="answer_6"></textarea>
                    <div class="contact_label">How will you (and/or the business) make money from the website?</div>
