<?php
    ...
    function create_blog_post_thumbnail($post) {
        $post_url = 'http://'.$_SERVER['SERVER_NAME'].'/blog/'.$post['slug'];
        $html =
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td class="partial_post_social_icons">
                                    ...
                                    <a href="https://www.pinterest.com/pin/create/button/?url='.$post_url.'&media=http://'.$_SERVER['SERVER_NAME'].$post['tall_image_url'].'&description='.urlencode($post['title']).'" target="_blank" data-pin-do="buttonPin" data-pin-config="above">
